...
export const BUILDING_TYPES: BuildingTypeDef[] = [
  ...
  // ===================== HEALTHCARE =====================
  {
    ...
    features: [
      ...
      { kind: "brise_soleil", params: { coverage: 0.6, projection: 2, spacing: 7, orientation: "vertical" } },
      { kind: "feature_corner", params: { wrap: 16 } },
      { kind: "plaza", params: { width: 70, depth: 44, grade: "unit_paver", seatWall: 46 } },
